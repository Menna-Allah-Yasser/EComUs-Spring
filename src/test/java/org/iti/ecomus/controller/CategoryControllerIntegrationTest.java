...
public class CategoryControllerIntegrationTest {
    ...
    public void getCategoryById_WithValidId_ShouldReturnCategory() throws Exception {
        ...
        MvcResult result = mockMvc.perform(post("/api/customer/category")
                        .with(csrf())
    ...
    public void createCategory_WithValidData_ShouldCreateCategory() throws Exception {
        ...
        mockMvc.perform(post("/api/customer/category")
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void deleteCategory_WithValidId_ShouldDeleteCategory() throws Exception {
        ...
        mockMvc.perform(delete("/api/customer/category/" + savedCategory.getCategoryId())
                        .with(csrf()))
                .andExpect(status().isOk());

        mockMvc.perform(get("/api/customer/category/" + savedCategory.getCategoryId()))
